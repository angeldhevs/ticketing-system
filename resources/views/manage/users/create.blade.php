...
<div class="container-fluid mt-3">
  <div class="row">
    <div class="col col-sm-12 col-md-6">
      <form method="POST" action="{{ route('manage.users.store') }}" data-method="POST">
        @csrf
        @include('components.input', [
          ...
          'attr' => [ 'required', 'autofocus','autocomplete' => 'off' ],
          'label' => [ 'text' => __('Name'), 'class' => 'col-md-4 col-form-label text-md-right' ],
          'wrappers' => [
            'outer' => [ 'class' => 'form-group row' ],
            'inner' => [ 'class' => 'col-sm-12 col-md-8' ]
          ],
          'error' => [ 'tag' => 'small', 'html' => '<strong>'.$errors->first('name').'</strong>' ]
        ])
        ...
        @include('components.select', [
          ...
          'error' => [
            'tag' => 'small',
            'html' => '<strong>'.$errors->first('role_id').'</strong>'
          ]
        ])
